...
-- Estudantes
INSERT INTO  Students ( student_id, name, gender, identify_no, nif, mobile_phone, email, 
                        test_result, vacinated, residence_name, deleted, date_created, 
...
INSERT INTO students (student_id, name, gender, identify_no, nif, mobile_phone, email,
                        test_result,vacinated, residence_name, deleted, 
...
INSERT INTO students (student_id, name, gender, identify_no, nif, mobile_phone,
                        email, test_result,vacinated, residence_name, 
                        deleted, date_created, date_updated, date_deleted)
...
--media dos valores de renda
select round(avg(nvl(payment,0)),2) as Media_Pagamento
from contract;

--entradas e saidas
select name, action_type, entry_date
from students_control sc 
join contract c on sc.contract_contract_id=c.contract_id
join students s on c.students_student_id=s.student_id;
